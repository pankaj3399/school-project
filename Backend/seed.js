...
//   console.error(
//     "Refusing to run destructive seed (it wipes the whole database).\n" +
//       "If you intend to reset a dev database: ALLOW_DESTRUCTIVE_SEED=true node seed.js\n" +
//       "Or: node seed.js --force\n" +
//       "Check Vercel/CI: Build Command must NOT run seed.js against production MONGO_URI."
//   );
//   process.exit(1);
// }
