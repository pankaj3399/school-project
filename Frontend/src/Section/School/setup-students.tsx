  ...
  const validateStudentData = (): boolean => {
    ...
    students.forEach((student, index) => {
      ...
      if (!student.firstName || !student.lastName) {
        errors.push(
          `Student ${identifier}: First Name and Last Name are required.`,
        );
      }
      ...
      if (!student.grade || student.grade.trim() === "") {
        ...
        errors.push(
          `Student ${identifier}: Grade must be one of the valid options (e.g., 'K', '1', '2', 'Case Manager #1', 'Program #1', etc.).`,
        );
      }
      ...
      if (!g1.name || !g1.email) {
        errors.push(
          `Student ${identifier}: Missing required Guardian 1 information (${
            !g1.name ? "name" : ""
          }${!g1.email ? ", email" : ""}).`,
        );
      }
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">
        Student Roster Setup {user?.schoolId?.name ? `for ${user.schoolId.name}` : ""}
      </h1>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-sm">
                    <li>
                      <b>First Name</b> - Student's first name
                    </li>
                    <li>
                      <b>Last Name</b> - Student's last name
                    </li>
                    <li>
                    ...
                    <li>
                      <b>Guardian 1 Email</b> - Primary guardian's email
                    </li>
                    <li>
                      <b>Guardian 2 Name</b> - Secondary guardian's name
                      (optional)
                    </li>
                    <li>
                      <b>Guardian 2 Email</b> - Secondary guardian's email
                      (optional)
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-sm">
                    <li>
                      <b>First Name & Last Name:</b> Required for all students
                    </li>
                    <li>
                      <b>Grade:</b> Required, must be one of: Regular grades
                      (K-12), Case Managers (#1-#20), Programs (#1-#20), or
                    ...
                    <li>
                      <b>Guardian 2 fields:</b> All optional, leave empty if not
                      applicable
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-sm">
                    <li>
                      Email addresses must be in valid format (e.g.,
                      user@domain.com)
                    </li>
                    <li>
